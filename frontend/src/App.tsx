      ...
      <div className="container mx-auto p-6">
        ...
        {isAuthenticated ? (
          <div className="bg-white rounded-lg shadow p-6">
            <p className="text-gray-600">Welcome! You're signed in as <strong>{user?.email}</strong></p>
            <p className="text-gray-600 mt-2">The main candidate analysis UI will go here in the next milestone.</p>
          </div>
        ) : (
